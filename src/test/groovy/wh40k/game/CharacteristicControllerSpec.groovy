...
@Mock([Characteristic, PlayingCharacter])
class CharacteristicControllerSpec extends Specification {
    ...
    def populateValidParams(params) {
		...
		params["stat"] = 50
		params["modifier"] = 20
		params["type"] = wh40k.enums.CharacteristicType.WS
    }
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        when:"The save action is executed with a valid instance"
			...
			playingCharacter.addToCharacteristics(characteristic)
    ...
    void "Test the update action performs an update on a valid domain instance"() {
		given: "A playingCharacer instance exists"
			populateValidParams(params)
			def playingCharacter = new PlayingCharacter(params)
    ...
    void "Test that the delete action deletes an instance if it exists"() {
		given: "A playingCharacter exists"
			populateValidParams(params)
			def playingCharacter = new PlayingCharacter(params)
